...
const options = {
    definition: {
        ...
        tags: [
            ...
            { name: 'Qualification', description: 'Public qualification flow endpoints' },
            { name: 'Partners', description: 'Public partner onboarding and partner actions' },
            ...
            { name: 'Admin Exclusivity', description: 'Admin postcode exclusivity rules' },
            { name: 'Admin Payouts', description: 'Admin introducer payouts' },
            { name: 'Admin Qualification', description: 'Admin qualification question management' },
        ],
        components: {
            securitySchemes: {
                bearerAuth: {
            ...
            schemas: {
                ...
                LeadSubmissionRequest: {
                    ...
                    properties: {
                        ...
                        preferredContactMethod: { type: 'string', enum: ['phone', 'email', 'either'], example: 'either' },
                        ...
                        fileUpload: {
                            ...
                            items: {
                                ...
                                properties: {
                                    ...
                                    fileUrl: { type: 'string', example: 'https://files.example.com/payslip.pdf' },
                                },
                            },
                        },
                ...
                LeadSubmissionResponse: {
                    ...
                    properties: {
                        message: { type: 'string', example: "Thanks — we'll match you shortly." },
